...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923287621448",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "F4H33M-H4CK3R",           // Owner's name
    DEV: process.env.DEV || "923287621448",                     // Developer's contact number
    DEVELOPER_NUMBER: 923287621448@s.whatsapp.net',            // Developer's WhatsApp ID

    // ===== AUTO-RESPONSE SETTINGS =====
    AUTO_REPLY: process.env.AUTO_REPLY || "false",              // Enable/disable auto-reply
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "true",// Reply to status updates?
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*F4H33M-H4CK3R VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "F4H33M-H4CK3R",     // Sticker pack name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ F4H33M-H4CK3R*",  // Bot description
